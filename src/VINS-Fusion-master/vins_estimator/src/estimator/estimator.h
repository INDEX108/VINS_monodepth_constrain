...
#include "../factor/Scale_shift.h"
#include "../factor/Self_Scale.h"
...
class Estimator
{
  public:
    ...
    void inputImage_depth(double t, const cv::Mat &_img, const cv::Mat &_img_depth = cv::Mat());
    ...
    double para_Sk[WINDOW_SIZE + 1][SIZE_SCALE_SHIFT];
