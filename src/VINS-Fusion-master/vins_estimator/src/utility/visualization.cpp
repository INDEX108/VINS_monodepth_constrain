...
ros::Publisher pub_image_depth_track;
...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_image_depth_track = n.advertise<sensor_msgs::Image>("image_track_depth", 1000);
...
void pubTrackImage_depth(const cv::Mat &imgTrack_depth, const double t)
{
    std_msgs::Header header;
    header.frame_id = "world";
    header.stamp = ros::Time(t);
    sensor_msgs::ImagePtr imgTrackMsg = cv_bridge::CvImage(header, "bgr8", imgTrack_depth).toImageMsg();
    pub_image_depth_track.publish(imgTrackMsg);
}
